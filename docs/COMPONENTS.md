...
Detailed feature lists for the scripts in this repository. Moved out of
`CLAUDE.md` on 29.08.2026, where it cost about 17.500 tokens in every request.

**Read this when:** changing one of these scripts, or when you need the exact
feature set or version of a component. For the rules that govern *how* to work
in this repository, stay in `CLAUDE.md`.
